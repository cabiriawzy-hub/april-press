...
window.BRIEFING_ITEMS = [
  ...
  },
  {
    ...
    body_zh: [
      "欧盟围绕 Digital Omnibus 推迟高风险 AI 义务的第二轮三方会谈在 4 月 28 日结束，未达成一致。三方（欧洲议会、理事会、委员会）谈了大约 12 小时；八月二日的法定截止日不动；下一轮三方会谈定在 5 月 13 日。",
      ...
      "四月给 2026 年最后留下的伏笔，可能是这一笔——它不构成新闻，但每一个赶进度的合规岗都把它放进了五月计划的第一行。卷十五（大家并不向往自动化）讲的是公众态度与采纳率的脱钩；这一篇是这种脱钩的第一份制度脚注——监管在公众情绪推压下减速，但不知道往哪边减。"
    ],
    body_en: [
  ...
  },
  {
    ...
    body_zh: [
      ...
      "为什么值得单开一章——它把「内容生成」和「界面承载内容」这两件事合并了。过去两年的 AI 产品几乎都是二段式：模型生成内容（文字、图、代码），然后由一层 HTML / chat UI / IDE 把内容呈现给用户。ChatGPT 把回复包在 chat bubble 里，Cursor 把代码写进编辑器，GPT Image 2（卷九）把图片插进 React 组件里——模型负责「内容」，工程负责「承载」。Flipbook 直接砍掉了「承载」那一段：界面本身就是模型输出的画面。",
      ...
      "值得自己上 flipbook.page 点一阵——比看任何写它的文章都更直观。即使最后被证明走不通——很可能——它也是 2026 年第一个把「AI-native 界面」问题摆到 demo 级别的产品。这种「砍掉中间层」的提案，AI 历史里通常会留下东西，即使提案者本人没活到下一轮。"
    ],
    body_en: [
